...
export const PREDEFINED_PROMPTS = {
  ...
  suggestFollowUpQuestions: {
    ...
    input:
      "Suggest two follow-up questions that the participant can ask to carry forward the conversation",
  },
} as const;
...
export const FOLLOW_UP_PROMPTS = {
  ...
  generateExecutiveSummary: {
    ...
    input:
      "Generate a one-paragraph executive summary of the conversation, including key points and decisions made",
  },
