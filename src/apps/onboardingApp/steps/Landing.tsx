...
export default function Landing() {
  ...
  return (
    <OnboardingPage
      className={`relative overflow-hidden ${isDarkMode ? "bg-[#0f0f0f]" : "bg-[#EDEEF2]"}`}
    >
      ...
      <div className="flex flex-row w-full h-full z-10 relative">
        ...
        <div className="flex-1 flex flex-col justify-between p-12 max-w-[500px]">
          ...
          <div className="flex items-center gap-2">
            <Logo size={32} />
            <span
              className={`text-xl font-semibold ${isDarkMode ? "text-[#F0F0F0]" : "text-[#1a1a1a]"}`}
            >
              AssistX
            </span>
          </div>
          ...
          <div className="flex flex-col gap-6">
            <div className="flex flex-col gap-4">
              <h1
                className={`text-4xl font-bold leading-tight tracking-tight ${isDarkMode ? "text-[#F0F0F0]" : "text-[#1a1a1a]"}`}
              >
                Your Intelligent
                <br />
              ...
              <p className={`text-lg ${isDarkMode ? "text-[#A0A0A0]" : "text-[#6B6B6D]"}`}>
                The open-source AI for smarter, more
                <br />
            ...
            <div className="flex flex-col gap-3">
              <OnboardingButton onClick={handleContinue} className="w-fit px-8" size="fit">
                Get Started
              </OnboardingButton>

              {/* Trust signal - right below the CTA */}
              <div
                className={`flex items-center gap-2 text-xs ${isDarkMode ? "text-[#888]" : "text-[#888]"}`}
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
          ...
          <div className="relative w-full max-w-[420px]">
            ...
            >
              ...
              <div className="flex items-center justify-between px-4 py-3 border-b bg-[#ffffff06] border-[#ffffff08]">
                <div className="flex items-center gap-2">
                  <span className="text-sm font-medium text-[#F0F0F0]">AssistX</span>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24"
                    fill="none"
              ...
              <div className="p-4 space-y-4">
                ...
                <div className="rounded-xl p-4 space-y-3 bg-[#ffffff10]">
                  ...
                  <p className="text-sm leading-relaxed text-[#E0E0E0]">
                    "I can help you with coding, writing, analysis, and much more. Just ask me
                    anything!"
                  </p>
                </div>
                ...
                <div className="rounded-xl px-4 py-3 flex items-center gap-2 bg-[#ffffff10]">
                  ...
                  <div className="flex gap-1">
                    <span className="px-1.5 py-0.5 rounded text-xs bg-[#ffffff15] text-[#999]">
                      Ctrl
                    </span>
                    <span className="px-1.5 py-0.5 rounded text-xs bg-[#ffffff15] text-[#999]">
                      ↵
