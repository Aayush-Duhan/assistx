...
export function SidebarSection({ title, items, isExpanded, onToggle, activePage, onPageChange }: SidebarSectionProps) {
    return (
        <div className="mb-2">
            <button
                onClick={onToggle}
                        ...
                        <div className="relative pl-3">
                            ...
                            {items.map((item, index) => {
                                ...
                                return (
                                    <div
                                        key={item.key}
                                        className="relative flex items-center group left-2"
                                    >
