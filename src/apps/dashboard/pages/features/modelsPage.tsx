...
const ModelsPage = () => {
  ...
  // Get built-in models for a provider (now returns AIModel[])
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-sm text-zinc-500">
            Browse available models and create custom configurations
          </p>
        </div>
        {!isAddingModel && (
          <button
                ...
                {builtInModels.map((model) => (
                  <div
                    ...
                    className={cn(
                      ...
                      hasApiKey ? "bg-zinc-800/40 text-zinc-300" : "bg-zinc-900/40 text-zinc-500",
                    )}
                  >
                    {model.modelId}
                  </div>
                ...
                {providerCustomModels.map((model) => (
                  ...
                  >
                    <div className="flex items-center gap-2 min-w-0">
                      ...
                      <span className="text-[9px] text-zinc-600 px-1 py-0.5 rounded bg-zinc-800/50">
                        custom
                      </span>
                    </div>
