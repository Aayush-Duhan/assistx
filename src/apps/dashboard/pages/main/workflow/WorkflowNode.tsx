...
const NODE_COLORS: Record<NodeKind, { bg: string; border: string; icon: string }> = {
    [NodeKind.Input]: { bg: "bg-emerald-500/10", border: "border-emerald-500/30", icon: "text-emerald-500" },
    [NodeKind.Output]: { bg: "bg-orange-500/10", border: "border-orange-500/30", icon: "text-orange-500" },
    [NodeKind.LLM]: { bg: "bg-violet-500/10", border: "border-violet-500/30", icon: "text-violet-500" },
    [NodeKind.Condition]: { bg: "bg-yellow-500/10", border: "border-yellow-500/30", icon: "text-yellow-500" },
    ...
    [NodeKind.Template]: { bg: "bg-slate-500/10", border: "border-slate-500/30", icon: "text-slate-400" },
        ...
        >
            ...
            <div className="p-3">
                ...
                <div className="flex items-center gap-2 mb-1">
                    <div className={cn("p-1.5 rounded-md", colors.bg, colors.icon)}>
                        {icon}
                    </div>
