...
export function ConversationContent() {
    ...
    const allResponses: UnifiedResponse[] = conversation.responses
        .map((response) => ({
            type: "done",
            response,
        }));
...
function OptimisticMessageGroup({
    ...
    return (
        ...
        >
            <UserMessage text={userText} screenshot={screenshot} hasScreenshot={hasScreenshot} />
...
function UserMessage({
    ...
    return (
        <div className="flex flex-col gap-1 justify-end items-end">
            ...
            {hasScreenshot && <ScreenshotTool url={screenshot} />}
        </div>
    );
}
