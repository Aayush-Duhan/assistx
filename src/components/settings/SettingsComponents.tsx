        ...
        <div className={cn(
            ...
            <div className="flex items-center gap-12">
                <div className="flex-1 space-y-1">
                    <h2 className={cn("text-lg font-medium", dark ? "text-white" : "text-stone-900")}>{title}</h2>
...
export function SettingsButton({ onClick, className, ...props }: React.ComponentProps<typeof HeadlessButton>) {
    return (
        <HeadlessButton
            className={cn(
