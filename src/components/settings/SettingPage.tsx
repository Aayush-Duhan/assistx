    ...
    <>
      <div className="p-8 h-full overflow-x-auto scrollbar scrollbar-thumb-stone-300 scrollbar-track-stone-100">
        ...
        <SettingsSection
          ...
          rightContent={
            <SettingsButton onClick={() => sendToIpcMain("toggle-invisible", null)}>
        ...
        <div className="flex justify-center gap-4">
          <SettingsButton onClick={() => sendToIpcMain("reset-onboarding", null)}>
            Reset onboarding
          </SettingsButton>
          <SettingsButton onClick={() => sendToIpcMain("quit-app", null)}>
            Quit {APP_NAME}
          </SettingsButton>
        </div>
      </div>
