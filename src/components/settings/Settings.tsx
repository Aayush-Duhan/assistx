...
// import { InlineShortcut } from './ui/Shortcut';
...
//     const { moveLeft, moveRight } = useMovableWindowApi();
...
//                         <InlineShortcut accelerator="CommandOrControl+\" />
//                     </div>
//                     <div className="flex items-center justify-between">
//                         <span className="text-white/90 text-sm">Generate Response</span>
//                         <InlineShortcut accelerator="CommandOrControl+Enter" />
//                     </div>
//                     <div className="flex items-center justify-between">
//                         <span className="text-white/90 text-sm">Reset Chat</span>
//                         <InlineShortcut accelerator="CommandOrControl+R" />
//                     </div>
//                     <div className="flex items-center justify-between">
//                         <span className="text-white/90 text-sm">Scroll AI Response</span>
//                         <div className="flex items-center gap-1">
//                             <InlineShortcut accelerator={useVimBindings ? "CommandOrControl+J" : "CommandOrControl+Down"} />
//                             <span className="text-white/60 text-xs">/</span>
//                             <InlineShortcut accelerator={useVimBindings ? "CommandOrControl+K" : "CommandOrControl+Up"} />
//                         </div>
//                     </div>
//                 </div>
//             </div>
