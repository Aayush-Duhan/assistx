...
export class AiConversation {
    ...
    constructor(contextService: ContextService, fullContext: ContextData, screenshot?: any, manualInput?: string) {
     ...
     */
    createNewResponse = (fullContext: ContextData, screenshot?: any, manualInput?: string): void => {
     ...
     */
    createResponseFromContext({ fullContext, newContext, screenshot, manualInput }: {
        ...
        return new AiResponse(messages, fullContext, manualInput, attachments, this.session);
    }
