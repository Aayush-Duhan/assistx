...
// ============================================================================
// Events sent TO Main Process (fire-and-forget, no response expected)
// ============================================================================
...
// ============================================================================
// Events sent TO Renderer Process (main -> renderer)
// ============================================================================
const IpcToRendererEventsSchema = {
    'dashboard-visibility': z.object({ visible: z.boolean() }),
    'hide-window': z.null(),
    'unhide-window': z.null(),
    'update-status': z.object({
        status: z.string(),
    }),
    'invisible-changed': z.object({
        invisible: z.boolean(),
    }),
    'available-displays': z.object({
        displays: z.array(z.any()),
    }),
    'recenter-movable-windows': z.null(),
    'display-changed': z.object({
        preservePosition: z.boolean().optional(),
    }),
};

// Export as TYPE (not value) to satisfy electron.ts type constraints
export type IpcToRendererEvents = {
    [K in keyof typeof IpcToRendererEventsSchema]: z.infer<typeof IpcToRendererEventsSchema[K]>
};

// ============================================================================
// IPC Invoke Events (request-response pattern)
// ============================================================================
...
// ============================================================================
// Type exports for electron main process
// ============================================================================
export type IpcMainEvents = typeof ipcToMainEvents;
export type IpcMainHandleEvents = typeof ipcInvokeEvents;

// Aliases for backward compatibility with electron/ipc/schema.ts naming
export const IpcMainEventSchema = ipcToMainEvents;
export const ipcMainHandlerEventsSchema = ipcInvokeEvents;
