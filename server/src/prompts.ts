...
export const USER_CONTEXT_PLACEHOLDER = randomUUID();
 ...
 */
export function getPromptWithContext(promptType: "system" | "screenshot", context: string): string {
  const prompt =
    promptType === "system" ? AI_PROMPT_CONFIG.systemPrompt : AI_PROMPT_CONFIG.screenshotPrompt;
